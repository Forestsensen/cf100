      ...
      <>
        ...
        >
          ...
          >
            ...
            {/* 更新集数徽章（已更N） */}
            {newEpisodes != null && newEpisodes > 0 && (
              <div
                className='absolute top-2 left-2 bg-orange-500 text-white text-[10px] sm:text-xs font-bold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-md shadow-md animate-pulse transition-all duration-300 ease-out group-hover:scale-110 group-hover:bg-orange-600'
                style={
                  {
                    WebkitUserSelect: 'none',
                    userSelect: 'none',
